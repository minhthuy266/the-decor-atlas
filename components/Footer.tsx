      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="font-serif text-2xl text-stone-900 block mb-6">The Decor Atlas.</Link>
          ...
          <div className="md:col-span-1 md:pl-8">
            ...
            <ul className="space-y-4 text-sm text-stone-500">
              <li><Link href="/" className="hover:text-stone-900 transition-colors">Journal</Link></li>
              <li><Link href="/shop" className="hover:text-stone-900 transition-colors">The Shop</Link></li>
              <li><Link href="/about" className="hover:text-stone-900 transition-colors">About Us</Link></li>
              <li><Link href="/tag/minimalism" className="hover:text-stone-900 transition-colors">Minimalism</Link></li>
              <li><Link href="/tag/architecture" className="hover:text-stone-900 transition-colors">Architecture</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-4 text-sm text-stone-500">
              ...
              <li><Link href="/accessibility" className="hover:text-stone-900 transition-colors">Accessibility Statement</Link></li>
              <li><Link href="/privacy" className="hover:text-stone-900 transition-colors">Do Not Sell My Info</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-stone-500 text-xs mb-4">Join 15,000+ subscribers. No spam, just design.</p>
            <button
